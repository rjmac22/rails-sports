# Cricket from First Principles: Winning the Game — Source Ledger

Use this file as the evidence ledger for the journalism piece.

## Source standard

Prefer sources in roughly this order:

1. MCC Laws and official ICC playing conditions.
2. Official scorecards, governing-body match reports and official transcripts.
3. Direct interviews or first-person comments from players, captains and coaches.
4. High-quality contemporary reporting.
5. Secondary explainers only where they add useful context not available from primary sources.

For every source, record what it actually establishes. Do not use a citation merely because it is broadly related to the subject.

## Formal rules and playing conditions
